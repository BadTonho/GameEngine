...
The repository completed the Phase 2 Linux rendering foundation and Phase 3A shader milestone. The public foundation, X11/Win32 platform paths, Vulkan RHI, resource uploads, deferred destruction, swapchain, triangle smoke path and offline Slang bootstrap pipeline are implemented locally. The full shader pipeline, including caches, variants and runtime reflection, remains pending.
...
- [ ] Shader cache, variants, deterministic shader identifiers and runtime reflection remain for the remainder of Phase 3.
